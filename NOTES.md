...
1. I ran "export XCURSOR_SIZE=24" to get grim + slurp screenshots working because environment variables are weird on hyprland with UWSM. HOWEVER, I did set this in my home.nix so I don't know if this is relevant
